...
h2 { color: white; background-color: #525D76; font-size:16px; }
h3 { color: white; background-color: #525D76; font-size:14px; }
body { color: #7f7e7e; background-color: white; }
b { color: black; background-color: #eeeeee; }
p { background: white; color: #7f7e7e; font-size:12px; }
a { color: #7f7e7e; }
hr { color: #525D76;}
-->
</style>
</head><body>
<h1>HTTP Status <?=$status_code.' - '.$message;?></h1>
