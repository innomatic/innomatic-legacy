 ...
 *
 * @package xajax
 * @version $Id: Xajax.php,v 1.2 2006/06/04 08:40:40 alex Exp $
...
class Xajax extends Singleton
{
     ...
     */
    public function ___construct($sRequestURI='',$sWrapperPrefix="xajax_",$sEncoding=XAJAX_DEFAULT_CHAR_ENCODING,$bDebug=false)
    {
