...
class DataAccessException extends \RuntimeException
{
    ...
    public function getErrorMessage()
    {
        $errorMessages = array(
            ...
            self::ERROR_CONSTRAINT_NOT_NULL => 'null value violates not-null ' . 'constraint',
        ...
        return isset($errorMessages[$this->getErrorCode()]) ? $errorMessages[$this->getErrorCode()] : $errorMessages[self::ERROR];
    }
}
