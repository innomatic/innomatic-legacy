...
class ModulePingerServer extends SocketHandler {
	...
	function onConnect($clientId = NULL) {
	}

	function onConnectionRefused($clientId = NULL) {
	}

	function onClose($clientId = NULL) {
	}

	function onReceiveData($clientId = NULL, $data = NULL) {
//print('dati ricevuti');
