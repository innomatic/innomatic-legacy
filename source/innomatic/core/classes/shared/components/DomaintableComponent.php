...
class DomaintableComponent extends ApplicationComponent
{
    ...
    function DoInstallAction ($params)
    {
        ...
        if (strlen($params['file'])) {
            ...
            if (@copy($params['file'], InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']))) {
                ...
                $this->mLog->logEvent('innomatic.domaintablecomponent.domaintablecomponent.doinstallaction', 'In application ' . $this->appname . ', component ' . $params['name'] . ': Unable to copy ' . $params['file'] . ' to destination ' . InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']), Logger::ERROR);
        } else
    ...
    function DoUninstallAction ($params)
    {
        ...
        if (strlen($params['file'])) {
            if (@unlink(InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']))) {
                ...
                $this->mLog->logEvent('innomatic.domaintablecomponent.domaintablecomponent.douninstallaction', 'In application ' . $this->appname . ', component ' . $params['name'] . ': Unable to remove ' . InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']), Logger::ERROR);
        } else
    ...
    function DoUpdateAction ($params)
    {
        ...
        if (strlen($params['file'])) {
            ...
            if (@copy($params['file'], InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']))) {
                ...
                $this->mLog->logEvent('innomatic.domaintablecomponent.domaintablecomponent.doupdateaction', 'In application ' . $this->appname . ', component ' . $params['name'] . ': Unable to copy ' . $params['file'] . ' to destination ' . InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']), Logger::ERROR);
        } else
    ...
    function doEnableDomainAction ($domainid, $params)
    {
        ...
        if (strlen($params['file'])) {
            ...
            $xmldb->load_deffile(InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . $params['file']);
    ...
    function doUpdateDomainAction ($domainid, $params)
    {
        ...
        if (strlen($params['file'])) {
            ...
            $xml_upd = new DataAccessXmlTableUpdater($this->domainda, InnomaticContainer::instance('innomaticcontainer')->getHome() . 'WEB-INF/db/' . basename($params['file']) . '.old', $params['file']);
            $xml_upd->CheckDiffs();
